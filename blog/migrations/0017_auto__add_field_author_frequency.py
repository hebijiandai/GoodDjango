...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.frequency'
        db.add_column(u'blog_author', 'frequency',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Author.frequency'
        db.delete_column(u'blog_author', 'frequency')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_qualification', (
            ...
            ('license', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('charactor', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.create_table(u'blog_objectattribution', (
            ...
            ('place', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        ...
        db.create_table(u'blog_myobject', (
            ...
            ('attribution', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Objectattribution'])),

...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Objectattribution.place'
        db.alter_column(u'blog_objectattribution', 'place', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'blog.objectattribution': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'place': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '50'})
        },

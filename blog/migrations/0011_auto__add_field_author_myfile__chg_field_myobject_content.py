...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Author.myfile'
        db.add_column(u'blog_author', 'myfile',
                      self.gf('django.db.models.fields.files.FileField')(default=0, max_length=100),
                      keep_default=False)


        # Changing field 'Myobject.content'
        db.alter_column(u'blog_myobject', 'content', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Deleting field 'Author.myfile'
        db.delete_column(u'blog_author', 'myfile')

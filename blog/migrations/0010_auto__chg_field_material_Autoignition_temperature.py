...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Material.Autoignition_temperature'
        db.alter_column(u'blog_material', 'Autoignition_temperature', self.gf('django.db.models.fields.SmallIntegerField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Material.Autoignition_temperature'
        db.alter_column(u'blog_material', 'Autoignition_temperature', self.gf('django.db.models.fields.CharField')(max_length=50))

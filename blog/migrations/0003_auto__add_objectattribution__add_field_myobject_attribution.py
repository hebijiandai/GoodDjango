...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Objectattribution'
        db.create_table(u'blog_objectattribution', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attribution', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('place', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'blog', ['Objectattribution'])

        # Adding field 'Myobject.attribution'
        db.add_column(u'blog_myobject', 'attribution',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['blog.Objectattribution']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Objectattribution'
        db.delete_table(u'blog_objectattribution')

        # Deleting field 'Myobject.attribution'
        db.delete_column(u'blog_myobject', 'attribution_id')

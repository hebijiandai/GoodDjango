...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Objectattribution.place'
        db.alter_column(u'blog_objectattribution', 'place', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Adding field 'Myobject.order'
        db.add_column(u'blog_myobject', 'order',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Objectattribution.place'
        db.alter_column(u'blog_objectattribution', 'place', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=50))
        # Deleting field 'Myobject.order'
        db.delete_column(u'blog_myobject', 'order')
